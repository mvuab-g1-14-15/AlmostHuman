...
// Creem la variable eyePos amb semàntica CAMERAPOSITION, contindrà la posició de la càmara
...
technique tec0
{
    pass p0
    {
        VertexShader =compile vs_1_1 RenderNormalsVS(g_WorldViewProjMatrix, g_WorldMatrix);
