...
{
    // TODO: Crear una variable float4 (DiffuseColor) on agafem el color difús de la textura mitjançant tex2D
    // TODO: Calculem la mitja aritmètica del rgb del color (DiffuseColor.x+DiffuseColor.y+DiffuseColor.z)/3.0f i ens donarà un valor que el retornarem en les 3 components del color
    // COMENTARI: També podem calcular el blanc i negre amb el càlcul DiffuseColor.x*0.3+DiffuseColor.y*0.59+DiffuseColor.z*0.11;
    // TODO: Crear una variable de tipus float4 inicialitzant-la a 1
    // TODO: Igualem les components xyz d'OUT al color blanc i negre (codi HLSL: OUT.xyz=BW;)
    // TODO: Retorna OUT
}
