...
void CPhysicMaterial::Update()
{
  ...
  if ( pActionManager->DoAction( "ShootRayCast" ) )
  {
    ...
    if ( l_CurrentCamera )
    {
      ...
      CPhysicUserData* l_PUD = l_PM->RaycastClosestActorShoot( l_CurrentCamera->GetPos(), l_CurrentCamera->GetDirection().GetNormalized(), mask,
  ...
  if ( pActionManager->DoAction( "DrawActor" ) )
  {
    ...
    CPhysicUserData* l_PUD = l_PM->RaycastClosestActor( l_CurrentCamera->GetPos(), l_CurrentCamera->GetDirection().GetNormalized(), mask,
                             l_SCollisionInfo );
