...
{
public:
    typedef enum {  BUTTON = 0, CHECKBUTTON, STATIC_TEXT, SLIDER, IMAGE, EDITABLE_TEXT_BOX, PROGRESS_BAR, DIALOG_BOX, RADIO_BOX} TypeGuiElement;
...
public:
    ...
    Math::Vect2i        GetPosition                 () const            {return m_Position;}
    const Math::Vect2f& GetPositionPercent          () const            {return m_PositionPercent;}
