...
private:
	...
	void	LoadSlider					(CSlider* slider, CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm);
	void	LoadDialogBox				(CDialogBox* dialogBox, CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm);
	void	LoadEditableTextBox (CEditableTextBox* editableTextBox, CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm);
	void	LoadRadioBox				(CRadioBox* radioBox, CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm);
	void	_LoadImage					(CImage* image, CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm);
	void	LoadProgressBar			(CProgressBar* progressBar, CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm);
	void	LoadStaticText			(CStaticText* staticText, CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm);
