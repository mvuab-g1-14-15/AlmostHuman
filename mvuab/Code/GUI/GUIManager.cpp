	...
	else
	{
		...
		if (m_bIsOk)
		{
			...
			if (m.Exists())
			{
				...
				m_TextBox =	new CTextBox(	m_ScreenResolution.x, m_ScreenResolution.y, h, w, Math::Vect2f(posx,posy), button_w, button_h);
				assert(m_TextBox);
	...
	if (m_bIsOk)
	{
		...
		if( !m_TextBox->IsVisible() && m_bLoadedGuiFiles)
		{
			...
			else
			{
				if (!m_bUpdateError)
				{
					LOG_ERROR_APPLICATION("CGUIManager:: Se ha intentado updatear la windows %s no registrada ", m_sCurrentWindows.c_str());
					m_bUpdateError = true;
				}
			}
	...
	if (m_sTransitionEffect.m_bDoEffect)
	{
		switch (m_sTransitionEffect.m_eType)
		{
			case TE_SHADOW:
			{
				...
				GraphicsInstance->DrawQuad2D(Math::Vect2i(0,0),m_ScreenResolution.x,m_ScreenResolution.y,CGraphicsManager::UPPER_LEFT,color);
			}
			break;
...
void CGUIManager::ActiveWindows( const std::string& inNameWindow )
{
	...
	if( it != m_WindowsMap.end() )
	{
		...
		{
			LOG_ERROR_APPLICATION("CGUIManager:: Al intentar cambiar de windows, la actual-->%s no se ha encontrado registrada", m_sCurrentWindows.c_str());
		}
	}
	else
	{
		LOG_ERROR_APPLICATION("CGUIManager:: Al intentar cambiar a la windows-->%s esta no se ha encontrado registrada", inNameWindow.c_str());
	}
}
...
void CGUIManager::PushWindows (const std::string& inNameWindow )
{
  ...
  {
    LOG_ERROR_APPLICATION("CGUIManager::PushWindows Al intentar cambiar a la windows-->%s etsa no se ha encontrado registrada", inNameWindow.c_str());
  }
}
...
void CGUIManager::SetActiveGuiElement (const std::string& inNameGuiElement, bool flag)
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion SetActiveGuiElement", inNameGuiElement.c_str());
	}
}
...
void CGUIManager::SetVisibleGuiElement (const std::string& inNameGuiElement, bool flag)
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion SetVisibleGuiElement", inNameGuiElement.c_str());
	}
}
...
bool CGUIManager::GetProgressBarValue (const std::string& inNameGuiElement, float& outValue)
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion GetProgressBarValue", inNameGuiElement.c_str());
	}
...
bool CGUIManager::SetProgressBarValue (const std::string& inNameGuiElement, float inValue)
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion SetProgressBarValue", inNameGuiElement.c_str());
	}
	return false;
}
...
std::string CGUIManager::GetButtonCheckInRadioBox (const std::string& inNameRadioBox)
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion GetButtonCheckInRadioBox", inNameRadioBox.c_str());
	}
...
void CGUIManager::SetStateCheckButton ( const std::string& inCheckButtonName, bool state )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion SetStateCheckButton", inCheckButtonName.c_str());
	}
}
...
bool CGUIManager::GetStateCheckButton( const std::string& inCheckButtonName )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion GetStateCheckButton", inCheckButtonName.c_str());
	}
	return false;
}
...
void CGUIManager::SetEditableTextBox( const std::string& inEditableText, const std::string& text )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion SetEditableTextBox", inEditableText.c_str());
	}
}
...
std::string CGUIManager::GetEditableTextBox( const std::string& inEditableText )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion GetEditableTextBox", inEditableText.c_str());
	}
	return "";
}
...
void CGUIManager::SetImage( const std::string& inImageName, const std::string& activeImage )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion SetImage", inImageName.c_str());
	}
}
...
std::string CGUIManager::GetImage( const std::string& inImageName )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion GetImage", inImageName.c_str());
	}
	return "";
}
...
void CGUIManager::SetStateSlider( const std::string& inSliderName, float amount )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion GetStateSlider", inSliderName.c_str());
	}
}
...
void CGUIManager::SetLiteralInStaticText( const std::string& inStaticText, const std::string& lit )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion SetVariableText", inStaticText.c_str());
	}
}
...
bool CGUIManager::NextBlockInRadioBox(  const std::string& inNameRadioBox )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion NextBlockInRadioBox", inNameRadioBox.c_str());
	}
	return false;
}
...
bool CGUIManager::PrevBlockInRadioBox(  const std::string& inNameRadioBox )
{
	...
	{
		LOG_ERROR_APPLICATION("CGUIManager:: No se ha encontrado el guiElement %s al ejecutar la funcion PrevBlockInRadioBox", inNameRadioBox.c_str());
	}
	return false;
}
//-------------------------------------------------------------------------
