        ...
        if (m_bIsOk)
        {
            ...
            if (m.Exists())
            {
                ...
                std::string texture                                 = m.GetPszProperty("texture",
                        "./Data/GUI/Textures_Test/gui_pointer_mouse.tga");
