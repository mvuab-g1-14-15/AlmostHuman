...
bool CWindows::ReleaseGuiElement( const std::string& name )
{
  ...
  LOG_WARNING_APPLICATION( "Windows:: Se ha intentado eliminar el GuiElement %s pero no existe en la windows %s", name.c_str(),
...
CButton* CWindows::LoadButton( CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm )
{
  ...
  CButton* button = new CButton( screenResolution.y, screenResolution.x, h, w, Math::Vect2f( posx, posy ), l_literal, heightOffset, widthOffset,
                                 visible, activated );
  button->SetName( name );
...
CCheckButton* CWindows::LoadCheckButton( CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm )
{
  ...
  CCheckButton* checkButton = new CCheckButton( screenResolution.y, screenResolution.x, h, w, Math::Vect2f( posx, posy ), isOn, l_literal, heightOffset,
...
CEditableTextBox* CWindows::LoadEditableTextBox( CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm )
{
  ...
  CEditableTextBox* editableTextBox = new CEditableTextBox( screenResolution.y, screenResolution.x, h, w, Math::Vect2f( posx, posy ),
