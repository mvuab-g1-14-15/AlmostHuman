...
CButton* CWindows::LoadButton (CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm)
{
	...
	CButton* button	= new CButton(screenResolution.y,screenResolution.x, h, w, Math::Vect2f(posx,posy), l_literal, heightOffset, widthOffset, visible, activated);
	button->SetName(name);
...
CCheckButton* CWindows::LoadCheckButton ( CXMLTreeNode& pNewNode, const Math::Vect2i& screenResolution, CTextureManager* tm)
{
	...
	CCheckButton * checkButton = new CCheckButton(screenResolution.y,screenResolution.x, h, w, Math::Vect2f(posx,posy), isOn, l_literal, heightOffset, widthOffset, visible, activated);
