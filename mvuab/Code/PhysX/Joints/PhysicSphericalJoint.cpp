...
void CPhysicSphericalJoint::SetInfo (const Math::Vect3f& anchor, CPhysicActor* actorA,  CPhysicActor* actorB)
{
    if (actorA == NULL)
    {
        LOG_ERROR_APPLICATION("PhysicSphericalJoint:: El primer actor pasado como argumento no puede ser null");
        return;
    }
...
void CPhysicSphericalJoint::SetInfoComplete (const Math::Vect3f& anchor, const Math::Vect3f& _axis,
        CPhysicActor* actorA,  CPhysicActor* actorB)
{
    if (actorA == NULL)
    {
        LOG_ERROR_APPLICATION("PhysicSphericalJoint:: El primer actor pasado como argumento no puede ser null");
