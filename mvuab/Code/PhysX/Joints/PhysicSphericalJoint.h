...
public:
	...
	void					SetInfoComplete		(const Math::Vect3f& anchor, const Math::Vect3f& _axis, CPhysicActor* actorA,  CPhysicActor* actorB =0);
	void					SetInfoRagdoll		(SSphericalLimitInfo _sInfo, CPhysicActor* actorA,  CPhysicActor* actorB =0);
	void					SetInfo				(const Math::Vect3f& anchor, CPhysicActor* actorA,  CPhysicActor* actorB =0);
