...
public:
  ...
  virtual void  OnEnter( CPhysicUserData* _Entity_Trigger1,
                         CPhysicUserData* _Other_Shape ) = 0;
  virtual void  OnLeave( CPhysicUserData* _Entity_Trigger1,
                         CPhysicUserData* _Other_Shape ) = 0;
  virtual void  OnStay( CPhysicUserData* _Entity_Trigger1,
                        CPhysicUserData* _Other_Shape ) = 0;
};
