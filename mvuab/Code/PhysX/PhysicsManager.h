...
public:
  ...
  bool          AddActor( const std::string& Name, const std::string& Type, const Math::Vect3f& _vDimension, const Math::CColor& Color = Math::colBLACK,
  ...
  bool			AddActorCapsule( const std::string& aName, float aRadius, float aHeight );
