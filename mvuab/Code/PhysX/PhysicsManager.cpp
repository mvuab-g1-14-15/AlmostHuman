    ...
    EShapesType shapeType /* = NX_ALL_SHAPES  */, uint32 impactMask/* =0xffffffff */ )
{
  ...
  NxU32 l_NumShapesCollision = m_pScene->overlapSphereShapes( l_CollisionSphere, (NxShapesType)shapeType, nbShapes, l_CollisionShapes, NULL, impactMask );
...
void CPhysicsManager::OverlapSphereActor ( float _fRadiusSphere, const Math::Vect3f& _vPosSphere, std::vector<CPhysicUserData*> &_ImpactObjects, uint32 _uiImpactMask )
{
  ...
  NxU32 l_NumShapesCollision = m_pScene->overlapSphereShapes ( l_WorldSphere, NX_ALL_SHAPES, nbShapes, shapes, NULL, _uiImpactMask );
