...
#define ROTMInstance			CEngineManagers::GetSingletonPtr()->GetRenderableObjectTechniqueManager()
...
#define ROMLInstance			CEngineManagers::GetSingletonPtr()->GetRenderableObjectsLayersManager()
#define SRCMInstance			CEngineManagers::GetSingletonPtr()->GetSceneRendererCommandManager()
