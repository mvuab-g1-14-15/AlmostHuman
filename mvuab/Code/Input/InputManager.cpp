...
CInputManager::CInputManager( CXMLTreeNode& atts )
    : CManager( atts ), m_bIsOk( false ), m_pDI( NULL ), m_pKB( NULL ), m_pMouse( NULL ), m_pGamePad( NULL ),
      m_bActiveMouse( true )
{
    /*  TODO RAUL
        PONER LECTURA XML
...
//----------------------------------------------------------------------------
bool CInputManager::HasGamePad( EInputDeviceType device ) const
{
...
//----------------------------------------------------------------------------
HRESULT CInputManager::GetPosition( EInputDeviceType idType, Math::Vect2i& pos )
{
    switch ( idType )
    {
        case IDV_MOUSE:
...
//----------------------------------------------------------------------------
bool CInputManager::GetGamePadLeftThumbDeflection( float32* pfX, float32* pfY, EInputDeviceType device )
{
    switch ( device )
    {
        case IDV_GAMEPAD1:
...
bool CInputManager::GetGamePadRightThumbDeflection( float32* pfX, float32* pfY, EInputDeviceType device )
{
    switch ( device )
    {
        case IDV_GAMEPAD1:
...
bool CInputManager::GetGamePadDeltaTriggers( float32* pfLeft, float32* pfRight, EInputDeviceType device )
{
    switch ( device )
    {
        case IDV_GAMEPAD1:
...
void    CInputManager::SetGamePadLeftMotorSpeed( uint32 speed, EInputDeviceType device )
{
    switch ( device )
    {
        case IDV_GAMEPAD1:
...
void    CInputManager::SetGamePadRightMotorSpeed( uint32 speed, EInputDeviceType device )
{
    switch ( device )
    {
        case IDV_GAMEPAD1:
...
//----------------------------------------------------------------------------
bool CInputManager::IsDown( EInputDeviceType idType, uint32 nBtn )
{
    bool result = false;
...
//----------------------------------------------------------------------------
bool CInputManager::IsDownUp( EInputDeviceType idType, uint32 nBtn )
{
    bool result = false;
...
// Ask about button/key state for mouse, joytsick or keyboard.
//----------------------------------------------------------------------------
bool CInputManager::IsUpDown( EInputDeviceType idType, uint32 nBtn )
{
    bool result = false;
