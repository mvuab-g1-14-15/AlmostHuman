...
void CInputDevice::Release( void )
{
    ...
    LOG_INFO_APPLICATION("InputDevice::nput device offline (ok)");
}
...
HRESULT CInputDevice::CrankUp(REFGUID rguid, LPCDIDATAFORMAT pdf, bool exclusiveMode)
{
    ...
    {
        LOG_ERROR_APPLICATION( "InputDevice: CreateDevice failed");
        return S_FALSE;
    }
    ...
    {
        LOG_ERROR_APPLICATION( "InputDevice: SetDataFormat failed");
        return S_FALSE;
    }
    ...
    {
        LOG_ERROR_APPLICATION("InputDevice: SetCoopLevel failed");
        return S_FALSE;
    }
