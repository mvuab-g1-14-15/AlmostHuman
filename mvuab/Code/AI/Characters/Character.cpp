...
void CCharacter::Update()
{
     ...
     Math::Vect3f l_LookAt = l_DessiredDirection;
     //l_Interpolator3D.Update( 1, l_LookAt );
     m_PController->SetYaw( Math::Utils::ATan2( l_LookAt.z, l_LookAt.x ) );
	 Vect3f l_NormlookAt = l_LookAt.GetNormalized();
	 float n = l_NormlookAt.Length();
     m_PController->Move( l_NormlookAt * m_Speed, deltaTime );
