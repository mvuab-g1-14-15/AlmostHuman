...
public:
    CCameraInfo();
    CCameraInfo(const Math::Vect3f &Eye, const Math::Vect3f &LookAt, const Math::Vect3f &Up, float32 NearPlane, float32 FarPlane, float32 FOV);
    CCameraInfo(CXMLTreeNode &attribs);
