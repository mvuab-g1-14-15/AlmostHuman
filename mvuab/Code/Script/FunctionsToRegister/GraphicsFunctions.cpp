...
void registerCameras(lua_State* aLuaState)
{
    ...
    LUA_DECLARE_METHOD(CCamera, GetFrustum)
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    LUA_BEGIN_DECLARATION(aLuaState)
    LUA_DECLARE_CLASS(CFrustum)
    LUA_DECLARE_METHOD(CFrustum, SphereIsVisible)
    LUA_END_DECLARATION
    ...
    LUA_DECLARE_METHOD(CCinematicManager, SetCinematicActive)
	...
	LUA_DECLARE_METHOD(CCinematicManager, CTemplatedVectorMapManager<CCinematic>::GetResource)
    LUA_END_DECLARATION
}
...
void registerAnimatedModels(lua_State* aLuaState)
{
    ...
    LUA_DECLARE_METHOD_PROTO(CAnimatedInstanceModel, RemoveAction, void(CAnimatedInstanceModel::*)(const std::string&))
...
void registerSceneRendererCommand(lua_State* aLuaState)
{
    ...
    LUA_DECLARE_METHOD(CSceneRendererCommandManager, GetZBlur)
    LUA_END_DECLARATION
}
...
void registerZBlur(lua_State* aLuaState)
{
    LUA_BEGIN_DECLARATION(aLuaState)
    LUA_DECLARE_CLASS(CZBlurSceneRendererCommand)
    LUA_DECLARE_METHOD(CZBlurSceneRendererCommand, AdjustLens)
    LUA_END_DECLARATION
}

void registerGraphics(lua_State* aLuaState)
{
    registerZBlur(aLuaState);
    ...
    LUA_DECLARE_METHOD(CScene, GetCurrentRoomName)
    LUA_DECLARE_METHOD(CScene, SetCurrentRoomName)
    LUA_END_DECLARATION
